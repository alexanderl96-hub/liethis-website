  ...
  return (
    <div className='mainAfro'>
      ...
      <div style={{display: 'flex', justifyContent: 'center'}}>
         <div style={{textAlign: 'center', width: '30%', color: 'white', fontSize: "20px", padding: '10px', cursor: 'pointer',backgroundColor: 'red'}}>Online Events</div>
         <div style={{textAlign: 'center', width: '30%', color: 'white', fontSize: "20px",padding: '10px', cursor: 'pointer'}}><Link to={'/afrocusoul/workshops/inperson'} style={{textDecoration: 'none', color: 'white'}}>In-Person Events</Link></div>
      </div>
   </div>
  )
}
